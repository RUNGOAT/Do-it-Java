...
//		aList3.set(4, 7);			java.lang.IndexOutOfBoundsException:
		...
		// 13-1. toArray(T[] t) -> T[]
		Integer[] integer1 = aList3.toArray(new Integer[0]);		// list의 size() >= 배열의 length -> list의 크기를 지는 배열 생성
		System.out.println(Arrays.toString(integer1));
		
		// 13-2. toArray(T[] t) -> T[]
		Integer[] integer2 = aList3.toArray(new Integer[5]);		// list의 size() < 배열의 length -> 배열 length의 크기를 지니는 배열 생성
